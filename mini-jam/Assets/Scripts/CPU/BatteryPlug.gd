...
@export var ChargeDecrease: float
...
func Animate() -> void:
	if StoredItem: Sprite.animation = "Full"
...
func _process(delta: float) -> void:
	...
	if Input.is_action_just_pressed("Interact") and PlayerThatWillPickUp and StoredItem:
		...
		StoredItem = null
	elif Input.is_action_just_pressed("Interact") and PlayerThatWillPickUp and PlayerThatWillPickUp.PickedUpItem:
